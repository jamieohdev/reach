...
public class BlemishLayerFeature extends Feature<NoneFeatureConfiguration> {
    public BlemishLayerFeature(Codec<NoneFeatureConfiguration> p_66836_) {
        super(p_66836_);
    }
        ...
        for(int i = 0; i < 16; ++i) {
            for(int j = 0; j < 16; ++j) {
                ...
                if (biome.shouldSnow(worldgenlevel, blockpos$mutableblockpos)) {
                    worldgenlevel.setBlock(blockpos$mutableblockpos, ReachBlocks.BLEMISH.get().defaultBlockState(), 2);
