...
public class ShardSmallFeature extends Feature<ColumnFeatureConfiguration>
{
    ...
    Block block;
    public ShardSmallFeature(Codec<ColumnFeatureConfiguration> deserializer, Block block)
    {
        super(deserializer);
        this.block = block;
    }
            ...
            if (blockpos1 != null) {
                ...
                for(BlockPos.MutableBlockPos blockpos$mutableblockpos = blockpos1.mutable(); j >= 0; --j) {
                    if (isAirOrLavaOcean(p_65168_, p_65169_, blockpos$mutableblockpos)) {
                        this.setBlock(p_65168_, blockpos$mutableblockpos, block.defaultBlockState());
                        blockpos$mutableblockpos.move(Direction.UP);
                        flag = true;
                    } else {
                        if (!p_65168_.getBlockState(blockpos$mutableblockpos).is(block)) {
                            break;
                        }
