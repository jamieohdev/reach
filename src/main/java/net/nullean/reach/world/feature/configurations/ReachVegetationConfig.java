...
public class ReachVegetationConfig extends BlockPileConfiguration {
    public static final Codec<ReachVegetationConfig> CODEC = RecordCodecBuilder.create((p_191267_) -> {
        ...
        })).apply(p_191267_, ReachVegetationConfig::new);
    });
    public final int spreadWidth;
    public final int spreadHeight;

    public ReachVegetationConfig(BlockStateProvider p_191263_, int p_191264_, int p_191265_) {
        super(p_191263_);
