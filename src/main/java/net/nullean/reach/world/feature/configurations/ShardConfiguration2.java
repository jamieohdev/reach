...
public class ShardConfiguration2 implements FeatureConfiguration {
    public static final Codec<ShardConfiguration2> CODEC = RecordCodecBuilder.create((p_160966_) -> {
        ...
        })).apply(p_160966_, ShardConfiguration2::new);
    });
    ...
    public ShardConfiguration2(int p_160956_, IntProvider p_160957_, FloatProvider p_160958_, float p_160959_, FloatProvider p_160960_, FloatProvider p_160961_, FloatProvider p_160962_, int p_160963_, float p_160964_) {
