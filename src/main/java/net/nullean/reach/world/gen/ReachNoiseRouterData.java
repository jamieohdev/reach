...
public class ReachNoiseRouterData {
    ...
    public static NoiseRouter reachRealm(HolderGetter<DensityFunction> p_224486_, HolderGetter<NormalNoise.NoiseParameters> p_256236_, boolean p_224487_, boolean p_224488_) {
