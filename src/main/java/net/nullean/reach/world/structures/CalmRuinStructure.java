...
public class CalmRuinStructure extends Structure {
    public static final Codec<CalmRuinStructure> CODEC = RecordCodecBuilder.create((p_229075_) -> {
        ...
        })).apply(p_229075_, CalmRuinStructure::new);
    });

    public final float largeProbability;
    public final float clusterProbability;

    public CalmRuinStructure(Structure.StructureSettings p_229060_, float p_229062_, float p_229063_) {
        super(p_229060_);
    ...
    {
        return onTopOfChunkCenter(p_226571_, Heightmap.Types.WORLD_SURFACE_WG, (p_229068_) -> {
    ...
    private void generatePieces(StructurePiecesBuilder p_229070_, Structure.GenerationContext p_229071_) {
        ...
        CalmRuinStructurePieces.addPieces(p_229071_.structureTemplateManager(), blockpos, rotation, p_229070_, p_229071_.random(), this);
    }


    @Override
    public StructureType<?> type() {
        return ReachStructureTypes.CALM_STRUCTURES.get();
    }
}
