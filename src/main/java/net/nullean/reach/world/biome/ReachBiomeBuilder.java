...
public class ReachBiomeBuilder
{
    ...
    private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{Biomes.NETHER_WASTES, Biomes.NETHER_WASTES, Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.NETHER_WASTES, Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.CRIMSON_FOREST, Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.NETHER_WASTES, Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.NETHER_WASTES, Biomes.NETHER_WASTES, Biomes.NETHER_WASTES, Biomes.NETHER_WASTES, Biomes.NETHER_WASTES}};
    ...
    private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST, Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.BASALT_DELTAS, Biomes.BASALT_DELTAS, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.BASALT_DELTAS, Biomes.BASALT_DELTAS, Biomes.BASALT_DELTAS, Biomes.BASALT_DELTAS, Biomes.SOUL_SAND_VALLEY}, {Biomes.BASALT_DELTAS, Biomes.BASALT_DELTAS, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST, Biomes.SOUL_SAND_VALLEY}, {Biomes.BASALT_DELTAS, Biomes.BASALT_DELTAS, Biomes.BASALT_DELTAS, Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY}};
    private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = new ResourceKey[][]{{Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY, null, null, null}, {Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY, null, null, null}, {Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY, null, null, null}, {null, null, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST, null}, {Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY, null, null}};
    private final ResourceKey<Biome>[][] EXTREME_HILLS = new ResourceKey[][]{{Biomes.WARPED_FOREST, Biomes.WARPED_FOREST, Biomes.SOUL_SAND_VALLEY, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.WARPED_FOREST, Biomes.WARPED_FOREST, Biomes.SOUL_SAND_VALLEY, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY, Biomes.SOUL_SAND_VALLEY, Biomes.CRIMSON_FOREST, Biomes.CRIMSON_FOREST}, {null, null, null, null, null}, {null, null, null, null, null}};
    ...
    private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187196_) {
        this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.NETHER_WASTES);

        this.addSkyBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.deepOceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, ReachBiomes.KELP_FOREST);

        this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.deepOceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, ReachBiomes.OCEAN_FROZEN);
        this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.oceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, ReachBiomes.OCEAN);
    }
    ...
    private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187218_, Climate.Parameter p_187219_) {
        this.addSurfaceBiome(p_187218_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187219_, 0.0F, ReachBiomes.BEACH);
    ...
    private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187229_, Climate.Parameter p_187230_) {
        this.addSurfaceBiome(p_187229_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187230_, 0.0F, ReachBiomes.BEACH);
        //Replace swamp to something
    ...
    private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187238_, Climate.Parameter p_187239_) {
        this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, p_187239_.max() < 0L ? Biomes.SNOWY_BEACH : Biomes.FROZEN_RIVER);
        this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, Biomes.FROZEN_RIVER);

        this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), p_187239_, 0.0F, Biomes.FROZEN_RIVER);
        this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, this.erosions[6], p_187239_, 0.0F, Biomes.FROZEN_RIVER);
        ...
        this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187239_, 0.0F, Biomes.FROZEN_RIVER);
    ...
    private void addUndergroundBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187227_) {
        this.addBottomBiome(p_187227_, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.DEEP_DARK);
        this.addMiddleUndergroundBiome(p_187227_, Climate.Parameter.span(-1.0F, 0.0F), Climate.Parameter.span(-1.0F, -0.25F), this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.DRIPSTONE_CAVES);
    }
