...
public class ParagonModel extends HierarchicalModel<Paragon>
{
    ...
    public ParagonModel(ModelPart part)
    {
        this.root = part;
    ...
    public void setupAnim(Paragon p_102719_, float p_102720_, float p_102721_, float p_102722_, float p_102723_, float p_102724_) {
