...
import net.nullean.reach.client.model.ParagonModel;
import net.nullean.reach.entity.monster.Paragon;
import org.joml.Matrix3f;
import org.joml.Matrix4f;

public class ParagonRenderer extends MobRenderer<Paragon, ParagonModel>
{
    private static final ResourceLocation Paragon_LOCATION = new ResourceLocation("reach:textures/entity/paragon.png");
    private static final ResourceLocation Paragon_BEAM_LOCATION = new ResourceLocation("textures/entity/guardian_beam.png");
    private static final RenderType BEAM_RENDER_TYPE = RenderType.entityCutoutNoCull(Paragon_BEAM_LOCATION);

    BlemishRenderer ref;

    public ParagonRenderer(EntityRendererProvider.Context context)
    {
        this(context, 0.5F, ReachModelLayers.PARAGON);
    }

    public ParagonRenderer(EntityRendererProvider.Context context, float par2, ModelLayerLocation par3)
    {
        super(context, new ParagonModel(context.bakeLayer(ReachModelLayers.PARAGON)), par2);
    }

    public boolean shouldRender(Paragon p_114836_, Frustum p_114837_, double p_114838_, double p_114839_, double p_114840_) {
    ...
    public void render(Paragon p_114829_, float p_114830_, float p_114831_, PoseStack p_114832_, MultiBufferSource p_114833_, int p_114834_) {
    ...
    public ResourceLocation getTextureLocation(Paragon p_114827_) {
        return Paragon_LOCATION;
    }
}
