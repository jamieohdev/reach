...
public class SpreaderBlastRenderer extends EntityRenderer<SpreaderBlast> {
    ...
    public SpreaderBlastRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    protected int getBlockLightLevel(SpreaderBlast p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(SpreaderBlast p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
    ...
    public ResourceLocation getTextureLocation(SpreaderBlast p_114078_) {
