...
public class ParagonNavigation  extends PathNavigation {

    FlyingPathNavigation ref;

    public ParagonNavigation(Mob p_26594_, Level p_26595_) {
        super(p_26594_, p_26595_);
    }

    protected PathFinder createPathFinder(int p_26598_) {
        this.nodeEvaluator = new ParagonNodeEvaluator();
