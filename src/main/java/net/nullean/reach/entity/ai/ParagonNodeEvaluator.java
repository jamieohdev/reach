package net.nullean.reach.entity.ai;
...
public class ParagonNodeEvaluator  extends NodeEvaluator {
    private final Long2ObjectMap<BlockPathTypes> pathTypesByPosCache = new Long2ObjectOpenHashMap<>();

    public ParagonNodeEvaluator() {
    }
    ...
    protected Node findAcceptedNode(int p_263032_, int p_263066_, int p_263105_) {
        ...
        if ( blockpathtypes == BlockPathTypes.BREACH || blockpathtypes == BlockPathTypes.OPEN) {
    ...
    public BlockPathTypes getBlockPathType(BlockGetter p_77472_, int p_77473_, int p_77474_, int p_77475_, Mob p_77476_, int p_77477_, int p_77478_, int p_77479_, boolean p_77480_, boolean p_77481_) {
        ...
        return blockstate1.isPathfindable(p_77472_, blockpos$mutableblockpos, PathComputationType.AIR) ? BlockPathTypes.OPEN : BlockPathTypes.BLOCKED;
    }
}