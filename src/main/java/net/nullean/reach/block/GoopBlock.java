...
public class GoopBlock extends HalfTransparentBlock {
    ...
    public GoopBlock(BlockBehaviour.Properties p_53985_) {
        super(p_53985_);
    }
    ...
    private static void showParticles(Entity p_53989_, int p_53990_) {
        if (p_53989_.level.isClientSide) {
            BlockState blockstate = ReachBlocks.GOOP.get().defaultBlockState();
