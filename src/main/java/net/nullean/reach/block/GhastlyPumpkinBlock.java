...
public class GhastlyPumpkinBlock extends StemGrownBlock {
    public GhastlyPumpkinBlock(BlockBehaviour.Properties p_55284_) {
        super(p_55284_);
    }
    ...
    public InteractionResult use(BlockState p_55289_, Level p_55290_, BlockPos p_55291_, Player p_55292_, InteractionHand p_55293_, BlockHitResult p_55294_) {
        ...
        if (itemstack.canPerformAction(net.minecraftforge.common.ToolActions.SHEARS_CARVE)) {
            if (!p_55290_.isClientSide) {
                ...
                p_55290_.setBlock(p_55291_, ReachBlocks.CARVED_GHASTLY_PUMPKIN.get().defaultBlockState().setValue(CarvedPumpkinBlock.FACING, direction1), 11);
                ItemEntity itementity = new ItemEntity(p_55290_, (double)p_55291_.getX() + 0.5D + (double)direction1.getStepX() * 0.65D, (double)p_55291_.getY() + 0.1D, (double)p_55291_.getZ() + 0.5D + (double)direction1.getStepZ() * 0.65D, new ItemStack(ReachItems.GHASTLY_PUMPKIN_SEEDS.get(), 4));
