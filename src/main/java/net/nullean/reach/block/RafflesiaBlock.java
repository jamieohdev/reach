...
public class RafflesiaBlock  extends Block
{
    private static final VoxelShape SHAPE = Block.box(2.0D, 1.0D, 2.0D,
            14.0D, 4.0D, 14.0D); // 2 13 2 14 16 14
    ...
    public RafflesiaBlock(BlockBehaviour.Properties p_154697_) {
        super(p_154697_);
    }
    ...
    public void animateTick(BlockState p_222503_, Level p_222504_, BlockPos p_222505_, RandomSource p_222506_) {
        ...
        p_222504_.addParticle(ParticleTypes.ASH, d0, d1, d2, 0.0D, 0.0D, 0.0D);
        ...
        for(int l = 0; l < 14; ++l) {
            ...
            if (!blockstate.isCollisionShapeFullBlock(p_222504_, blockpos$mutableblockpos)) {
                p_222504_.addParticle(ParticleTypes.ASH, (double)blockpos$mutableblockpos.getX() + p_222506_.nextDouble(), (double)blockpos$mutableblockpos.getY() + p_222506_.nextDouble(), (double)blockpos$mutableblockpos.getZ() + p_222506_.nextDouble(), 0.0D, 0.0D, 0.0D);
            }
        }
