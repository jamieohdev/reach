...
public class ReachSuspendedParticle extends TextureSheetParticle {
    ReachSuspendedParticle(ClientLevel p_172403_, SpriteSet p_172404_, double p_172405_, double p_172406_, double p_172407_) {
    ...
    ReachSuspendedParticle(ClientLevel p_172409_, SpriteSet p_172410_, double p_172411_, double p_172412_, double p_172413_, double p_172414_, double p_172415_, double p_172416_) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class BlemishSporeProvider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet sprite;

        public BlemishSporeProvider(SpriteSet p_108042_) {
        ...
        public Particle createParticle(SimpleParticleType p_108053_, ClientLevel p_108054_, double p_108055_, double p_108056_, double p_108057_, double p_108058_, double p_108059_, double p_108060_) {
            ...
            ReachSuspendedParticle suspendedparticle = new ReachSuspendedParticle(p_108054_, this.sprite, p_108055_, p_108056_, p_108057_, d0, d1, d2);
            suspendedparticle.setColor(0.45F, 0.1F, 0.45F);
    ...
    public static class SporeBlossomAirProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_172430_, ClientLevel p_172431_, double p_172432_, double p_172433_, double p_172434_, double p_172435_, double p_172436_, double p_172437_) {
            ReachSuspendedParticle suspendedparticle = new ReachSuspendedParticle(p_172431_, this.sprite, p_172432_, p_172433_, p_172434_, 0.0D, (double)-0.8F, 0.0D) {
    ...
    public static class UnderwaterProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_108074_, ClientLevel p_108075_, double p_108076_, double p_108077_, double p_108078_, double p_108079_, double p_108080_, double p_108081_) {
            ReachSuspendedParticle suspendedparticle = new ReachSuspendedParticle(p_108075_, this.sprite, p_108076_, p_108077_, p_108078_);
    ...
    public static class WarpedSporeProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_108095_, ClientLevel p_108096_, double p_108097_, double p_108098_, double p_108099_, double p_108100_, double p_108101_, double p_108102_) {
            ...
            ReachSuspendedParticle suspendedparticle = new ReachSuspendedParticle(p_108096_, this.sprite, p_108097_, p_108098_, p_108099_, 0.0D, d0, 0.0D);
